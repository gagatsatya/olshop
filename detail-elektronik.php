<?php
    ...
    $slug=$_GET['slug'];
    $elektroniks=query("SELECT*FROM elektroniks WHERE slug='$slug'")[0];
?>
...
<nav class="navbar navbar-expand-lg navbar-light">
    ...
    <div class="row" style="margin-top:100px">
        <div class="col-5">
            <img src="img/<?=$elektroniks['img']?>" alt="img" width="400" height=300">
        </div>
        <div class="col-4 align-self-center">
            <h4><?=$elektroniks['nama']?></h4>
            <h2 class="mt-2 mb-2">Rp <?=$elektroniks['harga']?></h2>
            <img src="img/star.svg" alt="img" width="20" height="20"><p style="display:inline"><?=$elektroniks['rating']?></p>
            <p class="mt-4 mb-4"><?=$elektroniks['deskripsi']?></p>
        </div>
