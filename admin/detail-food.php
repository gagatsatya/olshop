...
<nav class="navbar navbar-expand-lg navbar-light">
    ...
    <div class="row" style="margin-top:100px">
        ...
        <div class="col-3 align-self-center" style="text-align: center">
            <a href="ubah.php?tipe=makanan&&slug=<?=$food['slug']?>"><button class="btn btn-primary" style="padding:5px 20px 5px 20px">Ubah</button></a>
            <a href="hapus.php?tipe=makanan&&slug=<?=$food['slug']?>"><button class="btn btn-danger" style="padding:5px 20px 5px 20px">Hapus</button></a>
        </div>
    </div>
</div>
